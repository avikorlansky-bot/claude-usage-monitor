...
- **Always-current.** Polls claude.ai's internal usage endpoint every 10 seconds.
...
- **Optional floating window.** A small rounded, always-on-top panel that mirrors the dropdown, draggable anywhere on screen — with a **System / Light / Dark** theme submenu so it blends with whichever appearance you use.
